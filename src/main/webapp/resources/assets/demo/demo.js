  ...
  initMaterialWizard: function() {
    ...
    $('.card-wizard').bootstrapWizard({
      ...
      onTabShow: function(tab, navigation, index) {
        ...
        // If it's the last tab then hide the last button and show the finish
		// instead
        if ($current >= $total) {
  ...
  initSmallGoogleMaps: function() {
	...
	// Set up some of our variables.
      ...
      // This is called when the page has loaded.
          ...
          map = new google.maps.Map(document.getElementById('regularMap'), options);
          ...
          google.maps.event.addListener(map, 'click', function(event) {                
              ...
              if(marker === false){
                  ...
                  // Marker has already been added, so just change its
					// location.
      ...
      // This function will get the marker's current location and then add the
		// lat/long
      ...
      function markerLocation(){
          ...
          document.getElementById('formMap:lat').value = currentLocation.lat(); // latitude
          document.getElementById('formMap:lng').value = currentLocation.lng(); // longitude
      }
